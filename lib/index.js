export default class AggregationBuilder {
    constructor(model) {
         ...
         * @return this stage
         */
        this.sortArray = function (sortArrayParams, options) {
            if (!this.openStage("sortArray", options))
                return this;
         ...
         * @return this stage
         */
        this.search = function (SearchComponents, options) {
            if (!this.openStage("search", options))
                return this;
